...
class CoreDataManager {
  ...
  // MARK: - extension ItemCore
    ...
    func initTablewithItems() -> [ItemCore]  {
        ...
        _tableItems.append(newtask1 )
        _tableItems.append(newtask3 )
        _tableItems.append(newtask3 )
        _tableItems.append(newtask4 )
    ...
    //MARK: -  CoreData  save the context in the Database
    ...
    func saveData (){
       ...
       //MARK: -  CoreData
        func createNewItem(txt : String? =  nil, changed : Bool? = nil ) -> ItemCore{
    ...
    func getItems(predicate: NSPredicate? = nil,
            ...
            let _context:  NSManagedObjectContext  = CoreDataManager.shared.context
            
            return try!  _context.fetch(fetchRequest) // getContext().fetch(fetchRequest)
            
        }
        
     
        //MARK: -  CoreData checkifCoreDataExists
   ...
   // MARK: -  CoreData fetchCoreData_fromContext
    ...
    func fetchCoreData_fromContext() -> [ItemCore]{
     ...
     //MARK: -  CoreData writeData_toTableItems
